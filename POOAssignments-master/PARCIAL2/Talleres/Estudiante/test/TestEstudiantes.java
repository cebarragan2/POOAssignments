...
public class TestEstudiantes {
    ...
    @Test
      ...
      public void casosPasar1()
     {
         Materia materia=new Materia();
        String expResult="APROBADO";
        String actualResult=materia.estado(14,14,14);
        assertEquals(expResult,actualResult);
      ...
      public void casosPasar2()
     {
        ...
        String expResult="ERROR";
         String actualResult=materia.estado(21,21,21);
        assertEquals(expResult,actualResult);
      ...
      public void casosPasar3()
     {
        ...
        String expResult="ERROR";
         String actualResult=materia.estado(-2,-2,-2);
        assertEquals(expResult,actualResult);
      ...
      public void casosPasar4()
     {
       ...
       String expResult="SUPLETORIO";
       String  actualResult=materia.estado(13.99f,13.99f,13.99f);
        assertEquals(expResult,actualResult);
      ...
      public void casosPasar5()
     {
        ...
        String expResult="REPROBADO";
       String actualResult=materia.estado(11f,11f,11f);
        assertEquals(expResult,actualResult);
      ...
      public void casosPasar6()
     {
        ...
        String expResult="REPROBADO";
       String actualResult=materia.estado('A',11f,11f);
        assertEquals(expResult,actualResult);
      ...
      public void casosPasar7()
     {
        ...
        String expResult="REPROBADO";
       String actualResult=materia.estado('R',11f,11f);
        assertEquals(expResult,actualResult);
