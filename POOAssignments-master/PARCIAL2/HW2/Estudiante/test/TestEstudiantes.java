...
import static ec.edu.espe.enums.EstadoAcademico.ERROR;
    ...
    @Test
     ...
     public void casosNotas11()
     {
        float nota1;
         ...
         nota3=13.0f;
         Materia materia=new Materia();
        EstadoAcademico expResult=APROBADO;
        EstadoAcademico actualResult=materia.estado(nota1,nota2,nota3);
     ...
     public void casosNotas26()
     {
        float nota1;
         ...
         nota3=13.9999f;
         Materia materia=new Materia();
        EstadoAcademico expResult=SUPLETORIO;
        EstadoAcademico actualResult=materia.estado(nota1,nota2,nota3);
        assertEquals(expResult,actualResult);
     ...
     public void casosNotas41()
     {
        float nota1;
         ...
         nota3=11.97f;
         Materia materia=new Materia();
         EstadoAcademico expResult=REPROBADO;
         EstadoAcademico actualResult=materia.estado(nota1,nota2,nota3);
        assertEquals(expResult,actualResult);
    ...
    @Test
     ...
     public void casosNotas105()
     {
        ...
        assertEquals(expResult,actualResult,delta);
         ...
         expResult=15.9f;
         delta=15.9f;
         actualResult=materia.promedio(11f,12f,13f);
        assertEquals(expResult,actualResult,delta);
        
        expResult=-1f;
         delta=-1f;
         actualResult=materia.promedio(0f,0f,0f);
        assertEquals(expResult,actualResult,delta);
        
        expResult=-1f;
         delta=-1f;
         actualResult=materia.promedio(21f,-1f,16f);
        assertEquals(expResult,actualResult,delta);
        
        expResult=14.00f;
         delta=14.00f;
         actualResult=materia.promedio(14f,13.99f,14f);
        assertEquals(expResult,actualResult,delta);
        
        expResult=14.00f;
         delta=14.00f;
         actualResult=materia.promedio(13.99f,14f,14f);
        assertEquals(expResult,actualResult,delta);
        
        expResult=13.95f;
         delta=13.95f;
         actualResult=materia.promedio(13.94f,13.95f,13.5f);
        assertEquals(expResult,actualResult,delta);
         
     }
     @Test 
      public void casosPasar()
     {
        float nota1;
         float nota2;
         float nota3;
      ...
      @Test 
      public void casosPasar1()
     {
         Materia materia=new Materia();
        EstadoAcademico expResult=APROBADO;
        EstadoAcademico actualResult=materia.estado(14,14,14);
        assertEquals(expResult,actualResult);
      ...
      @Test 
      public void casosPasar2()
     {
         Materia materia=new Materia();
        
        
        EstadoAcademico expResult=ERROR;
          EstadoAcademico actualResult=materia.estado(21,21,21);
        assertEquals(expResult,actualResult);
      ...
      @Test 
      public void casosPasar3()
     {
         Materia materia=new Materia();
        
         EstadoAcademico expResult=ERROR;
          EstadoAcademico actualResult=materia.estado(-2,-2,-2);
        assertEquals(expResult,actualResult);
      ...
      @Test 
      public void casosPasar4()
     {
         Materia materia=new Materia();
       
        
        EstadoAcademico expResult=SUPLETORIO;
        EstadoAcademico  actualResult=materia.estado(13.99f,13.99f,13.99f);
        assertEquals(expResult,actualResult);
       
         
     }
      @Test 
      public void casosPasar5()
     {
         Materia materia=new Materia();
        
        
         EstadoAcademico expResult=REPROBADO;
        EstadoAcademico actualResult=materia.estado(11f,11f,11f);
        assertEquals(expResult,actualResult);
      ...
      @Test 
      public void casosPasar6()
     {
         Materia materia=new Materia();
        
        
         EstadoAcademico expResult=REPROBADO;
        EstadoAcademico actualResult=materia.estado('A',11f,11f);
        assertEquals(expResult,actualResult);
      ...
      @Test 
      public void casosPasar7()
     {
         Materia materia=new Materia();
        
        
         EstadoAcademico expResult=REPROBADO;
        EstadoAcademico actualResult=materia.estado('R',11f,11f);
        assertEquals(expResult,actualResult);
      ...
      @Test 
      public void casoAprovo1()
     {
        Estudiante estudiante= new Estudiante();
        
        String expResult="Pierde Semestre";
        String actualResult=estudiante.estadoAcademic(REPROBADO, REPROBADO, REPROBADO);
        assertEquals(expResult,actualResult);
      ...
      @Test 
      public void casoAprovo2()
     {
        Estudiante estudiante= new Estudiante();
        
         String expResult="SEMESTRE APROBADO";
        String actualResult=estudiante.estadoAcademic(APROBADO, APROBADO, APROBADO);
        assertEquals(expResult,actualResult);
       ...
       @Test 
      public void casoAprovo3()
     {
        Estudiante estudiante= new Estudiante();
        
         String expResult="POR ASIGNAR";
        String actualResult=estudiante.estadoAcademic(APROBADO, SUPLETORIO, APROBADO);
        assertEquals(expResult,actualResult);
